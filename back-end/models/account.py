...
# Account(fullName, email, password, phone, avatar, role_id, status, deleted, deleteAt)
...
class Account(Document):
    ...
    token = StringField(default=generate_random_string)  # Tự động tạo token
    ...
    meta = {
        "collection": "accounts",  # Tên collection trong MongoDB
